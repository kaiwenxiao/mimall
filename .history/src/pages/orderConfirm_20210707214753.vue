                        ...
                        <div class="order-box">
                              <div class="item-addr">
                                    ...
                                    <div class="addr-list clearfix">
                                          <div class="addr-info fl" :class="{ 'checked' : index == checkindex}"
                                    ...
                                    <ul>
                                          <li v-for="(item,index) in cartList" :key="index">
                                                <div class="good">
                                                      ...
                                                      <div class="good-price">{{item.productPrice}}元x{{item.quantity}}
                                                      </div>
                              ...
                              <div class="btn-group">
                                    <div class="btn-large btn-default" @click="backtoCart">返回购物车</div>
                                    <div class="btn-large btn" @click="orderConfirm">去结算</div>
                              </div>
                        </div>
                  </div>
            </div>
            <modal title="删除订单" btnType="3" :showModal="showdelModal" @cancel="showdelModal=false" @submit="submitAddr">
                  <template v-slot:body>
                        <span>您确认要删除此地址吗？</span>
                  </template>
            </modal>
            <modal title="编辑确认" btnType="3" :showModal="showEditModal" @cancel="showEditModal=false"
                  @submit="submitAddr">
                  <template v-slot:body>
                        <div class="edit-wrap">
                              <div class="item">
                              ...
                              <div class="item">
                                    <textarea name="street" v-model="checkItem.receiverAddress" id></textarea>
                              </div>
                              <div class="item">
...
export default {
      ...
      methods: {
            ...
            submitAddr() {
                  let timer, submit = submit();
                  return function () {
                        let context = this;
                        let args = arguments;
                        clearTimeout(timer);
                        timer = setTimeout(() => {
                              submit.call(context, args);
                        }, 1000);
                  }
            },
            submit() {
